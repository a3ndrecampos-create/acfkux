...
import com.rotacerta.entregador.ui.screens.ConfigScreen
import com.rotacerta.entregador.ui.screens.HistoricoScreen
import com.rotacerta.entregador.ui.screens.RotaScreen
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            RotaCertaTheme(lightTheme = config.lightTheme) {
                // Pede câmera e notificações ao abrir
                ...
                Scaffold(
                    ...
                    NavHost(
                        ...
                        startDestination = "rota",
                        modifier = Modifier.padding(padding)
                    ) {
                        // RotaScreen agora não precisa de onAddClick — o botão
                        // de escanear pedido é autocontido dentro da própria tela.
                        composable("rota") { RotaScreen(viewModel) }
